...
export default function GroupCombinedModalNew({ 
  isOpen, 
  onClose, 
  group,
  subCommittee,
  ...
  const tabs = [
    ...
    { 
      ...
      label: 'Phân công', 
      icon: Building,
      count: currentGroup.assignments?.length || 0
    },
    { 
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">{currentGroup.leader?.fullName}</p>
                </div>
                <div>
                  <span className="text-gray-600">Thư ký:</span>
                  <p className="font-medium">{currentGroup.secretary?.fullName}</p>
                </div>
              </div>
            </div>
