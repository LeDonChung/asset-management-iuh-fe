...
export default function TransactionDetailPage() {
  ...
  const { currentTransactionDetail, isFetchingTransaction, fetchTransactionError } =
  ...
  if (fetchTransactionError || !currentTransactionDetail) {
    return (
      <div className="flex flex-col items-center justify-center h-64 space-y-4">
        ...
        <Button onClick={() => router.push("/asset/transaction")} variant="outline">
          Quay lại danh sách
        </Button>
      </div>
    );
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="font-medium">
                    {typeLabels[currentTransactionDetail.type] || currentTransactionDetail.type}
                  </div>
                </div>
              ...
              {(currentTransactionDetail.approvalNote || currentTransactionDetail.rejectionReason) && (
                <>
                  <Separator className="my-4" />
                      ...
                      <div className="space-y-2">
                        ...
                        {currentTransactionDetail.approver && (
                          <div className="text-xs text-gray-500">
                            Người phê duyệt: {currentTransactionDetail.approver.fullName}
                          </div>
                        )}
                      </div>
                    )}
