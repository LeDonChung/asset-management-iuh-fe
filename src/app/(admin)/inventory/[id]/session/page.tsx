      ...
      <div className="bg-white rounded-xl border border-gray-200">
        ...
        <div className="p-6 border-b border-gray-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* Right Column - Creator & Management Info */}
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <span className="text-sm font-medium text-gray-700">Trạng thái kỳ kiểm kê</span>
                </div>
              ...
              <div className="bg-yellow-50 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <span className="text-sm font-medium text-yellow-800">Thao tác nhanh</span>
                </div>
                <div className="space-y-2">
                  <Link 
                    href={`/inventory/${session.id}/committees`}
                    className="flex items-center justify-between p-2 bg-white rounded border border-yellow-200 hover:bg-yellow-50 transition-colors"
                  >
                    <span className="text-sm text-yellow-800">Quản lý ban kiểm kê</span>
                  ...
                  <Link 
                    ...
                    className="flex items-center justify-between p-2 bg-white rounded border border-yellow-200 hover:bg-yellow-50 transition-colors"
                  >
                    <span className="text-sm text-yellow-800">Xem báo cáo</span>
        ...
        {/* Tab Placeholders - Future Implementation */}
        <div className="p-6">
          ...
          <div className="mt-6 text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Các tab sẽ được phát triển sau</h3>
            <p className="text-gray-500 max-w-md mx-auto">
              Các chức năng quản lý ban kiểm kê, tiểu ban, phân công đơn vị và báo cáo sẽ được triển khai trong các phiên bản tiếp theo.
            </p>
          </div>
        </div>
      </div>
