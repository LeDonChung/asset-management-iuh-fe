...
export default function InventorySessionDetailPage() {
  ...
  // Tab state for switching between overview and management
  const [activeMainTab, setActiveMainTab] = useState<'overview' | 'management' | 'result'>('overview');
            ...
            <div className="border-b border-gray-200">
              <nav className="flex space-x-8 px-6" aria-label="Tabs">
                {[
                  ...
                  { id: 'management', label: 'Quản lý ban kiểm kê', icon: Settings },
                                ...
                                <div className="flex-1 mx-4">
                                  <div
                                    className={`h-0.5 w-full ${
                                      isPastStatus || (isCurrentStatus && index < 3)
                                        ? 'bg-green-600'
                                        : 'bg-gray-300'
                                    }`}
                                  />
