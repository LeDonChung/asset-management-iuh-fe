  ...
  const renderAssetInventory = () => {
    ...
    return (
      <div className="space-y-8">
        ...
        <div className={`bg-white border border-gray-200 rounded-lg shadow-sm p-4 md:p-6 ${
          currentStep === InventoryStep.ASSET_INVENTORY ? 'hidden md:block' : ''
        }`}>
        ...
        <div className={`md:hidden bg-white border-b border-gray-200 p-3 fixed top-0 left-0 right-0 z-50 ${
          currentStep === InventoryStep.ASSET_INVENTORY ? 'block' : 'hidden'
        }`}>
          <div className="flex items-center gap-3">
            <button 
              onClick={() => goBackToStep(InventoryStep.ROOM_SELECTION)}
              ...
              <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full flex-shrink-0 ${
                    getSelectedDeviceInfo()?.status === 'online' ? 'bg-green-100 text-green-700' :
            ...
            <div className="flex flex-col items-center space-y-4 md:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 justify-center ${
                    !selectedDevice || !rfidConnected
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 md:gap-6">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 w-full lg:w-auto">
                ...
                <button 
                  ...
                  className={`flex items-center gap-2 px-4 py-2 text-white rounded-lg text-sm font-medium transition-colors duration-200 justify-center sm:justify-start ${
                    selectedAssetType === AssetType.TSCD 
              ...
              <div>
                ...
                <div className="mt-2 flex flex-wrap gap-2 text-xs text-gray-500">
                  <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full ${
                    getTSCDConfirmationStatus() === 'Đã xác nhận' 
                  ...
                  <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full ${
                    getCCDCConfirmationStatus() === 'Đã xác nhận' 
